...
SECRET_KEY = '+xmbazb)*v#a)jf*uh$(#(t73vthe#3xj)x20ug0lg3(f9r=+-'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'trackerapp/media')
STATIC_ROOT = os.path.join(BASE_DIR, 'trackerapp/static')
